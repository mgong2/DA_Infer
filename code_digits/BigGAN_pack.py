...
class Discriminator(nn.Module):
    ...
    def __init__(self, D_ch=64, D_wide=True, resolution=128,
        ...
        self.linear_mi_d = self.which_linear(self.arch['out_channels'][-1], 2)
        self.linear_c_d = self.which_linear(self.arch['out_channels'][-1], 2)
...
class G_D(nn.Module):
    ...
    def forward(self, z, gy, x=None, dy=None, train_G=False, return_G_z=False,
        ...
        # along the batch dimension for improved efficiency.
            ...
            if x is not None:
                if return_G_z:
                    return D_out[:G_z.shape[0]], D_out[G_z.shape[0]:], mi, cls, G_z
                else:
                    return D_out[:G_z.shape[0]], D_out[G_z.shape[0]:], mi, cls  # D_fake, D_real

            else:
                if return_G_z:
                    return D_out, mi, cls, G_z
                else:
                    return D_out, mi, cls
